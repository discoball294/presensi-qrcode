<!DOCTYPE html>
<html>
<!-- Mirrored from light.pinsupreme.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2018 03:26:52 GMT -->
            ...
            <div class="menu-and-user">
                <div class="logged-user-w">
                    ...
                    <div class="logged-user-info-w">
                        <div class="logged-user-name">Bryan Kristian</div>
        ...
        <div class="desktop-menu menu-side-w menu-activated-on-click">
            <div class="logo-w">
                <a class="logo" href="index-2.html">
                    ...
                    <div class="logo-label">Presensi SM Bethany Malang</div>
                </a>
            </div>
            <div class="menu-and-user">
                <div class="logged-user-w">
                    ...
                    <li class="has-sub-menu {{ (Route::is('murid.*')||Route::is('kelas.*')||Route::is('sesi-kelas.*')||Route::is('bulk')? 'active':'') }}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="{{ Route::is('bulk')? 'active':'' }}">
                                <a href="{{ route('bulk') }}">Bulk Add Murid Baru
                                </a>
                            </li>
...
<!-- Mirrored from light.pinsupreme.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2018 03:30:13 GMT -->
