                ...
                <div class="row m-b">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 b-b b-r">
                                <div class="el-tablo centered padded">
                                    <div class="value">{{ $murid->poin->sum('poin') }}</div>
                                    <div class="label">Poin <br>
                                        <a href="javascript:void(0)" id="btn-history"
                                           style="text-decoration: underline">Lihat history >></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
