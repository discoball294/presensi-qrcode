...
@section('title')
    <title>Daftar Murid - Admin</title>
@stop

@section('content-box')
    <div class="element-wrapper">
        <h6 class="element-header">Murid</h6>
        <div class="element-box">
            <h5 class="form-header">Daftar Murid</h5>
            <div class="form-desc">Berisi data murid sekolah minggu
            </div>
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', 'a.poin-btn', function (e) {
