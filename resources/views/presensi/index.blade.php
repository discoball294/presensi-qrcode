    ...
    <div class="auth-box-w">
        ...
        <form action="#">
            <div class="form-group" style="margin-bottom: 0px">
                ...
                <input class="form-control" placeholder="ID Murid" type="text" id="id-murid" name="id"
                       autocomplete="off">
                <div class="pre-icon os-icon os-icon-fingerprint"></div>
            </div>
            <small id="emailHelp" class="form-text text-muted"><a class="btn btn-link"
                                                                  href="{{ route('murid.create') }}">Tambah murid
                    baru</a></small>
            <div class="row">
                <div id="interactive" class="form-control">
