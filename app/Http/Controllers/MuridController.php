...
class MuridController extends Controller
{
    ...
    public function bulkAddPost(Request $request)
    {
        for ($i = 0; $i < $request->jumlah; $i++) {
            ...
            $murid->gender = 'N';
            $murid->nama_panggilan = 'Murid Baru';
            $murid->tempat_lahir = 'Murid Baru';
            $murid->tanggal_lahir = Carbon::now();
            $murid->nama_ayah = 'Murid Baru';
            $murid->nama_ibu = 'Murid Baru';
            $murid->no_telepon = '00';
            $murid->alamat = 'Murid Baru';
            $murid->foto = 'Murid Baru';
    ...
    public function indexDT()
    {
        ...
        try {
            $dt = DataTables::of($murid)
                ...
                ->removeColumn('tempat_lahir', 'nama_ibu', 'alamat', 'no_telepon', 'foto', 'created_at', 'updated_at')
                ->make(true);
